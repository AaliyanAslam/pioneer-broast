...
export default function CartDrawer({ isOpen, onClose }) {
  ...
  const { exactLocation, deliveryArea, deliveryCity, orderType } =
    useLocationStore();
  const router = useRouter();

  const defaultArea = exactLocation
    ? exactLocation.address
    : deliveryArea || "Not selected";
          ...
          {cart.length === 0 ? (
            ...
            <div className="space-y-4 pb-6">
                    ...
                    >
                      <div className="flex gap-4 items-center flex-1 pr-4">
                        ...
                        <div className="flex flex-col">
                          <h3 className="text-[13px] sm:text-[14px] uppercase text-zinc-900 leading-snug truncate max-w-[140px]">
                            {item.name}
                          </h3>
              ...
              <div className="px-4 sm:px-6">
                <button
                  onClick={onClose}
                  className="flex items-center gap-2 text-zinc-500 hover:text-black font-medium text-[15px] transition-colors mt-2"
                >
                  ...
                  <div className="mt-6 bg-[#e63946] rounded-xl pt-4 pb-1.5 px-1.5 relative">
                    ...
                    <div className="bg-white rounded-lg p-3 sm:p-4 relative pt-5">
                      <div className="absolute -top-4 left-1/2 -translate-x-1/2 flex bg-white rounded-full shadow-sm p-1 border border-zinc-100 whitespace-nowrap">
                        ...
                        <button
                          className="text-zinc-400 px-4 py-1.5 rounded-full text-[10px] font-bold tracking-wide cursor-not-allowed"
                          title="Online Payment Currently Disabled"
                        >
                          ONLINE PAYMENT
                        </button>
                      </div>
                        ...
                        <div className="mt-2 space-y-2">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              value={defaultArea}
                              disabled
                              className="w-full border border-zinc-200 rounded px-2 py-1.5 text-[12px] bg-zinc-50 text-zinc-500 cursor-not-allowed"
                            />
                          </div>
                          <div className="flex justify-end pt-2">
                            <button
                              onClick={() => setIsEditing(false)}
                              className="bg-black text-white px-4 py-1.5 rounded-lg text-[12px] font-bold"
                            >
                              Save Details
                            </button>
                          </div>
                        ...
                        <div className="flex justify-between items-start mt-2">
                          ...
                          <div className="w-[40%] flex flex-col items-end justify-between h-[60px]">
                            <button
                              ...
                              className="text-[#0ea5e9] flex items-center gap-1 text-[12px] font-medium"
                            >
