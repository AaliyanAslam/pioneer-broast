...
const KARACHI_AREAS = [
  ...
  "North Karachi Sector 11-D",
  "North Karachi Sector 11-E",
  "North Karachi Sector 11-F",
  "New Karachi",
  "Buffer Zone",
  "Shadman Town",
  ...
  switch (city) {
    case "Karachi":
      return (
        ...
        >
          <path
            d="M4 20h16M7 20V12h10v8M12 4a5 5 0 0 0-5 5v3h10V9a5 5 0 0 0-5-5z"
            strokeLinecap="round"
    ...
    case "Lahore":
      return (
        ...
        >
          <path
            d="M8 22h8M10 22V12h4v10M12 4L8 10h8l-4-6zM12 4V2M10 10v2M14 10v2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        </svg>
    ...
    case "Islamabad":
      return (
        ...
        >
          <path
            d="M2 22h20M12 8L4 20h16L12 8zM12 8V4M6 22V6M18 22V6"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        </svg>
    ...
    case "Multan":
      return (
        ...
        >
          <path
            d="M4 22h16M6 22V14a6 6 0 0 1 12 0v8M12 6a4 4 0 0 0-4 4h8a4 4 0 0 0-4-4zM12 6V3M8 18h8"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        </svg>
    ...
    case "Gujranwala":
      return (
        <svg
          ...
          style={{ color: active ? "#ed1c24" : "#4b5563" }}
        >
    ...
    case "Faisalabad":
      return (
        ...
        >
          <path
            d="M8 22h8M10 22V10h4v12M9 10V6h6v4M12 6L9 2h6l-3 4z"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
    ...
    case "Bahawalpur":
      return (
        ...
        >
          <path
            d="M2 22h20M4 22V14h16v8M8 14V8a4 4 0 0 1 8 0v6M12 8V4M7 8a2 2 0 0 0 4 0M13 8a2 2 0 0 0 4 0"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        </svg>
    ...
    case "Larkana":
      return (
        ...
        >
          <path
            d="M4 22h16M6 22V16h12v6M8 16V10h8v6M10 10V6a2 2 0 0 1 4 0v4M12 6V3"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        </svg>
    ...
    default:
      return (
        ...
        >
          <path
            d="M6 22h12M8 22V10M16 22V10M8 10C8 6 16 6 16 10"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M12 10V4M12 4L10 6M12 4L14 6"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        </svg>
...
export default function LocationModal() {
  ...
  const isMissingAreaForKarachi =
    deliveryCity === "Karachi" && !deliveryArea && !exactLocation;
  const shouldShow =
    isLocationModalOpen || orderType === null || isMissingAreaForKarachi;
  ...
  return (
    ...
    >
      <div
        ...
        onClick={
          !orderType ||
          (localCity === "Karachi" && !localArea && !exactLocation)
            ? undefined
            : handleClose
        }
      />
